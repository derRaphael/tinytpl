...
<div class="container" role="main">
    <div class="bg"><div>404</div></div>
    <div class="box">
        <h1>There is an error here, sorry.</h1>
        <hr />
        <p>
            The page you requested could not be found. If you followed a link to this page,
            it's very likely that the link is either misspelled or outdated.
        </p>
